label hospital:
    ...
    menu hospital_visits:
        ...
        "Tell the truth":
            ...
            But you are only removed form him [pc_sheet.GENERATION - 1] times.
        ...
        "Tell a lie":
            $ roll_janos = Roll(janos_sheet.INTELIGENCE + janos_sheet.MANIPULATION, janos_sheet.hunger, difficulty=0)
            $ roll_janos.roll()
            ...
            if roll_pc.margin_of_success > 0:
                "/You lay back confidently, knowing that the secret to every good lie is in details./"
                show pc idle at right
                pc """
                You caught me.
